...
Enterprise-grade Spring Boot starter library providing JWT Authentication, Refresh Token Rotation (RTR), JTI Token Revocation, Role-Based Access Control (RBAC), Role Hierarchy, and an extensible security architecture through SPI interfaces.
